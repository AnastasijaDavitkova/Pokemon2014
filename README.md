...
<ul>
<li>
Доколку успеете да го поразите противникот како награда се додалува одреден број на coins и доколку за првпат сте победилe против тој Pokemon добивате беџ како знак за успешно одиграна битка. 
